...
// Exportação unificada para facilitar o loop no Vue
export const allGiftCategories = [
  { categoryName: "Daily Links - Work once a week on the given day", items: dailyGifts },
  { categoryName: "One-Time Links without expiry date", items: oneTimeGifts },
  { categoryName: "Event Links - Only Work During The Roulette Event - Only Try Then!", items: eventGifts }
];